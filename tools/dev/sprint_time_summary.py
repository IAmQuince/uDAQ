...
def main() -> int:
    ...
    parser.add_argument('--ledger-jsonl', default='audit_reports/active/SPRINT_TIME_LEDGER__20260330_09.jsonl')
    parser.add_argument('--output-md', default='audit_reports/active/SPRINT_TIME_SUMMARY__20260330_09.md')
