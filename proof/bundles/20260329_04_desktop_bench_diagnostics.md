...
- Diagnostics output: `/mnt/data/udq_run04/proof/bundles/20260329_04_desktop_bench_diagnostics.json`
- Launch command: `python -m tools.ui.run_desktop_bench_harness --package-root "/mnt/data/udq_run04" --diagnostics-path "/mnt/data/udq_run04/proof/bundles/20260329_04_desktop_bench_diagnostics.json"`
