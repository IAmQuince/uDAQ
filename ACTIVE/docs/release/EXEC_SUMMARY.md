...
This package implements the first feature-bearing sprint after Sprint Zero: sandbox-only mapping mutation. The implementation proves that prepared mapping changes can be applied to isolated sandbox state, diffed, rolled back, and tested without granting live mapping authority or touching hardware.
