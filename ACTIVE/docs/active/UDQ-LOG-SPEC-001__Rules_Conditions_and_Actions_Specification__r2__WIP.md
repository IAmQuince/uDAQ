...
depends_on:
  ...
  - "UDQ-OUT-SPEC-001"
supersedes:
  - "UDQ-LOG-SPEC-001__Rules_Conditions_and_Actions_Specification__r1__WIP.md"
revision_history:
  - "r2 | 2026-03-21 | Subsystem reconciliation pass: clarified that rules emit governed requests rather than hidden direct writes."
...
- r2: Subsystem reconciliation pass: clarified that rules emit governed requests rather than hidden direct writes.
...
## 2A. Semantic Closure and Anti-Conflation Rule [SEC:UDQ-LOG-SPEC-001::2A]

Rules shall evaluate governed conditions and produce requests, recommendations, or evidence-bearing actions according to policy. Rules shall not become a hidden bypass around command arbitration or authorization. Where a rule influences a commandable target, the resulting path shall still be represented as a request entering backend-governed arbitration.
